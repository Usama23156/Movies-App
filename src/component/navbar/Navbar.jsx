     ...
     <FontAwesomeIcon className='text-2xl text-[color:var(--main-color)]' icon={faFilm}/>
      ...
      <div
        ...
        <ul className='flex flex-col md:flex-row md:text-center justify-center items-center md:space-x-0 gap-x-20 gap-y-5 py-5 '>       
          ...
          <li className="relative"><Link to="Tv" smooth={true} duration={100}><NavLink onClick={() => setOpen(false)} className={`font-medium text-base md:text-[color:var(--main-color)] text-[color:var(--text-color)] ${scrollPosition > 50?'md:text-[color:var(--text-color)]':'md:text-[color:var(--main-color)]'}`} to="Tv">Tv</NavLink></Link> </li>
        </ul>
            </div>
